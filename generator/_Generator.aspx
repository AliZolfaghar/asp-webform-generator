                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <asp:TextBox CssClass="form-control" ID="TextBox_PageTitle" runat="server" placeholder="Persian : Page Title / Name"></asp:TextBox>
                                    </div>
                            ...
                            <div class="form-group">
                                <asp:Button ID="Button_LoadTable" runat="server" Text="Load Table Fields" CssClass="btn btn-sm btn-success" />
                            </div>
                            <div class="form-group">
                            ...
                            <asp:Button ID="Button_Generate" runat="server" Text="Generate Code" CssClass="btn btn-primary btn-sm" />
                        </div>
                    </div>
                </div>
                ...
                <div class="col-6">
                    <div class="card border-success">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    <asp:Button ID="Button_Export" runat="server" Text="Export To File" CssClass="btn btn-sm btn-primary" />
